...
<div class="container">
    <div class="row">
        <div class="col-lg-12 margin-tb">
            ...
            <div class="pull-right">
                <a class="btn btn-primary" href="{{ route('inventarioMatrizPapeleria.index4') }}"> Atrás</a>
            </div>
        </div>
    </div>
    @if (count($errors) > 0)
    ...
    @endif
    <hr>
    {!! Form::open(array('route' => ['EntradaPapeleria.update4', $material->id],'method'=>'POST')) !!}
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            ...
            <div class="form-group">
                ...
                {!! Form::number('numero_factura', null, array('placeholder' => '4001','class' => 'form-control')) !!}
            </div>
        </div>
       ...
       <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                {!! Form::number('precio', null, array('placeholder' => '100','class' => 'form-control')) !!}
            </div>
        </div>
