...
<div class="container">
    <div class="row">
        <div class="col-lg-12 margin-tb">
            ...
            <div class="pull-right">
                <a class="btn btn-primary" href="{{ route('pendientesAdmin.pendienteLab') }}"> Atrás</a>
            </div>
        </div>
    </div>
    @if (count($errors) > 0)
    ...
    @endif
    <hr>
    {!! Form::open(array('route' => ['SalidaMatriz.updateinvsalidaclinicosped', $material->id],'method'=>'POST')) !!}
    <div class="row">
