...
class SalidaMatrizController extends Controller
{
        ...
        public function reducirped($id)
    {
        $material = MaterialClinica::find($id);
        $users = User::all();
        return view('inventarioMatrizClinica.reducirtomapedido', compact('material', 'users'));
    }

    public function reducirclinicosped($id)
    {
        $material = MaterialClinica::find($id);
        $users = User::all();
        return view('inventarioMatrizClinica.reducirclinicospedidos', compact('material', 'users'));
    }
...
public function updateinvsalida (Request $request, $id)
    ...
    public function updateinvsalidaped (Request $request, $id)
    {
        ...
        return redirect()->route('pendientesAdmin.pendienteClinico', compact('material'));
    ...
    public function updateinvsalidaclinicos (Request $request, $id)
    {
        ...
        public function updateinvsalidaclinicosped (Request $request, $id)
    {
            $this->validate($request, [
            'materialclinica_id' => 'required',
            'user_id' => 'required',
        ...
        return redirect()->route('pendientesAdmin.pendienteLab', compact('material'));
